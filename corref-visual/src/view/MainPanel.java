...
public final class MainPanel extends JPanel
{
    ...
    private static final String [] AJUDA = {//não consegui contornar o problema do joptionpane não dar wrap automático
            "No presente, a ferramenta é mantida por Marcelo Azevedo (marcelo.bernardy@acad.pucrs.br).\n"
...
//        });
    ...
    private void testeCores(ArrayList<Sintagma> sint){
        if(colors.isEmpty()){
                gerarCores();
            }   
        for(int i=0; i<colors.size();i++){    
            for(int j=0;j<sint.size();j++){
            if(colors.get(i)==sint.get(j).getCor()){
                colors.remove(i);
                break;
    ...
    private void gerarCores(){
       colors.add(new Color(160,1,1));
       colors.add(new Color(1,160,1));
       colors.add(new Color(1,1,160));
        colors.add(new Color(255,0,0));
        colors.add(new Color(0, 197, 205));
        colors.add(new Color(205, 92, 92));
        colors.add(new Color(0, 0, 205));
        colors.add(new Color(139, 37, 0));
        colors.add(new Color(0, 205, 0));
        colors.add(new Color(139, 37, 0));
        colors.add(new Color(0, 205, 102));
        colors.add(new Color(238, 130, 98));
        colors.add(new Color(148, 0, 211));
        colors.add(new Color(0, 154, 205));
        colors.add(new Color(199, 21, 133));
        colors.add(new Color(139,62,47));
        colors.add(new Color(255, 140, 0));
        colors.add(new Color(0, 104, 139));
        colors.add(new Color(152, 251, 152));
        colors.add(new Color(0, 0, 205));
        colors.add(new Color(238, 121, 66));
        colors.add(new Color(255, 106, 106));
        colors.add(new Color(205, 0, 0));
        colors.add(new Color(255, 165, 79));
        colors.add(new Color(0, 255, 255));
        colors.add(new Color(238, 64, 0));
        colors.add(new Color(205, 91, 69));
        colors.add(new Color(127,255,0));
        colors.add(new Color(139, 0, 0));
        colors.add(new Color(155, 48, 255));
        colors.add(new Color(0, 0, 238));
        colors.add(new Color(0, 0, 255));
        colors.add(new Color(104, 34, 139));
        colors.add(new Color(132, 112, 255));
        colors.add(new Color(151, 255, 255));
        colors.add(new Color(67, 110, 238));
        colors.add(new Color(153, 50, 204));
        colors.add(new Color(139, 60, 0));
        colors.add(new Color(255, 114, 86));
        colors.add(new Color(192,255,62));
        colors.add(new Color(205, 133, 63));
        colors.add(new Color(255, 20, 147));
        colors.add(new Color(255, 0, 255));
        colors.add(new Color(255, 62, 150));
        colors.add(new Color(255, 127, 36));
        colors.add(new Color(178, 58, 238));
        colors.add(new Color(180, 82, 205));
        colors.add(new Color(205, 105, 201));
        colors.add(new Color(205, 112, 84));
        colors.add(new Color(176, 196, 222));
        colors.add(new Color(123, 104, 238));
        colors.add(new Color(240,128,128));
        colors.add(new Color(238, 48, 167));
        colors.add(new Color(0, 229, 238));
        colors.add(new Color(205, 85, 85));
        colors.add(new Color(160, 82, 45));
        colors.add(new Color(137, 104, 205));
    ...
    public class ListItemTransferHandler extends TransferHandler
    {
        ...
        public boolean importData(TransferHandler.TransferSupport info)
        {
            ...
            {//(O(|S|)
                ...
                removal = true;
                /*alterando aqui para que cada grupo receba uma core pré definida*/
